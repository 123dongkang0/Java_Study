package com.redis.chapter19.base;
...
import com.redis.chapter19.pojo.Role;
...
public class Chapter19Main {
	...
	public void testPubSub() {
		ApplicationContext applicationContext = new ClassPathXmlApplicationContext("applicationContext-redis-cluster.xml");
		RedisTemplate redisTemplate = applicationContext.getBean(RedisTemplate.class);
		String channel = "chat";
